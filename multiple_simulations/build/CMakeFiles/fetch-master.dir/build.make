...
CMakeFiles/fetch-master:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/bdm/demo/multiple_simulations/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Fetch latest changes from origin master. If you forked the project,"
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "       make sure that it is synchronized with the biodynamo repository!"
	cd /home/bdm/demo/multiple_simulations && git fetch origin master
