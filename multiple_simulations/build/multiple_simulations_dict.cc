...
#define R__DICTIONARY_FILENAME dIhomedIbdmdIdemodImultiple_simulationsdIbuilddImultiple_simulations_dict
...
#include "/home/bdm/demo/multiple_simulations/src/multiple_simulations.h"
...
namespace ROOT {
   static void *new_bdmcLcLDivide(void *p = 0);
   static void *newArray_bdmcLcLDivide(Long_t size, void *p);
   static void delete_bdmcLcLDivide(void *p);
   static void deleteArray_bdmcLcLDivide(void *p);
   static void destruct_bdmcLcLDivide(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::bdm::Divide*)
   {
      ::bdm::Divide *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::bdm::Divide >(0);
      static ::ROOT::TGenericClassInfo 
         instance("bdm::Divide", ::bdm::Divide::Class_Version(), "", 36,
                  typeid(::bdm::Divide), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::bdm::Divide::Dictionary, isa_proxy, 4,
                  sizeof(::bdm::Divide) );
      instance.SetNew(&new_bdmcLcLDivide);
      instance.SetNewArray(&newArray_bdmcLcLDivide);
      instance.SetDelete(&delete_bdmcLcLDivide);
      instance.SetDeleteArray(&deleteArray_bdmcLcLDivide);
      instance.SetDestructor(&destruct_bdmcLcLDivide);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::bdm::Divide*)
   {
      return GenerateInitInstanceLocal((::bdm::Divide*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::bdm::Divide*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace bdm {
//______________________________________________________________________________
atomic_TClass_ptr Divide::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *Divide::Class_Name()
{
   return "bdm::Divide";
}

//______________________________________________________________________________
const char *Divide::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::bdm::Divide*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int Divide::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::bdm::Divide*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *Divide::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::bdm::Divide*)0x0)->GetClass();
   return fgIsA;
}
...
TClass *Divide::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::bdm::Divide*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace bdm {
//______________________________________________________________________________
void Divide::Streamer(TBuffer &R__b)
{
   // Stream an object of class bdm::Divide.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(bdm::Divide::Class(),this);
   } else {
      R__b.WriteClassBuffer(bdm::Divide::Class(),this);
   }
}
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_bdmcLcLDivide(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::bdm::Divide : new ::bdm::Divide;
   }
   static void *newArray_bdmcLcLDivide(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::bdm::Divide[nElements] : new ::bdm::Divide[nElements];
   }
   // Wrapper around operator delete
   static void delete_bdmcLcLDivide(void *p) {
      delete ((::bdm::Divide*)p);
   ...
   static void destruct_bdmcLcLDivide(void *p) {
      typedef ::bdm::Divide current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::bdm::Divide
...
namespace ROOT {
   static TClass *vectorlEbdmcLcLSimulationmUgR_Dictionary();
   static void vectorlEbdmcLcLSimulationmUgR_TClassManip(TClass*);
   static void *new_vectorlEbdmcLcLSimulationmUgR(void *p = 0);
   static void *newArray_vectorlEbdmcLcLSimulationmUgR(Long_t size, void *p);
   static void delete_vectorlEbdmcLcLSimulationmUgR(void *p);
   static void deleteArray_vectorlEbdmcLcLSimulationmUgR(void *p);
   static void destruct_vectorlEbdmcLcLSimulationmUgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<bdm::Simulation*>*)
   {
      vector<bdm::Simulation*> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<bdm::Simulation*>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<bdm::Simulation*>", -2, "vector", 386,
                  typeid(vector<bdm::Simulation*>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEbdmcLcLSimulationmUgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<bdm::Simulation*>) );
      instance.SetNew(&new_vectorlEbdmcLcLSimulationmUgR);
      instance.SetNewArray(&newArray_vectorlEbdmcLcLSimulationmUgR);
      instance.SetDelete(&delete_vectorlEbdmcLcLSimulationmUgR);
      instance.SetDeleteArray(&deleteArray_vectorlEbdmcLcLSimulationmUgR);
      instance.SetDestructor(&destruct_vectorlEbdmcLcLSimulationmUgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<bdm::Simulation*> >()));

      ::ROOT::AddClassAlternate("vector<bdm::Simulation*>","std::vector<bdm::Simulation*, std::allocator<bdm::Simulation*> >");
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<bdm::Simulation*>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEbdmcLcLSimulationmUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<bdm::Simulation*>*)0x0)->GetClass();
      vectorlEbdmcLcLSimulationmUgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEbdmcLcLSimulationmUgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<bdm::Simulation*> : new vector<bdm::Simulation*>;
   }
   static void *newArray_vectorlEbdmcLcLSimulationmUgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<bdm::Simulation*>[nElements] : new vector<bdm::Simulation*>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEbdmcLcLSimulationmUgR(void *p) {
      delete ((vector<bdm::Simulation*>*)p);
   }
   static void deleteArray_vectorlEbdmcLcLSimulationmUgR(void *p) {
      delete [] ((vector<bdm::Simulation*>*)p);
   }
   static void destruct_vectorlEbdmcLcLSimulationmUgR(void *p) {
      typedef vector<bdm::Simulation*> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<bdm::Simulation*>
...
namespace {
  void TriggerDictionaryInitialization_multiple_simulations_dict_Impl() {
...
"/home/bdm/demo/multiple_simulations/build/omp",
"/home/bdm/biodynamo/build/include",
"/home/bdm/demo/multiple_simulations/src",
"/home/bdm/biodynamo/build/third_party/root/include/",
"/home/bdm/demo/multiple_simulations/build/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "multiple_simulations_dict dictionary forward declarations' payload"
...
namespace bdm{class __attribute__((annotate("$clingAutoload$core/simulation.h")))  __attribute__((annotate("$clingAutoload$biodynamo.h")))  Simulation;}
...
namespace bdm{struct __attribute__((annotate(R"ATTRDUMP(pattern@@@bdm::*)ATTRDUMP"))) Divide;}
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "multiple_simulations_dict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("multiple_simulations_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_multiple_simulations_dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_multiple_simulations_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_multiple_simulations_dict() {
  TriggerDictionaryInitialization_multiple_simulations_dict_Impl();
}
